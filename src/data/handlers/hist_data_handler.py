...
class History_Data_Handler():
    def __init__(self, date_column = 'run_date'):
    ...
    def write_history(self):
        with open(os.path.join('src', 'data', 'history.csv'), 'w', newline='') as new_history:
            new_history.write(History_Data_Handler.format_row(self.headers))
